...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data: AllProjects } = ([__temp, __restore] = withAsyncContext(() => useFetch(useRuntimeConfig().baseURL + "/server/projects", "$qAMUi0sLZr")), __temp = await __temp, __restore(), __temp);
    var projects;
    projects = AllProjects.value.filter((element) => element.project_areas.includes("Health"));
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="introduction" data-v-3797eff9><div id="title" data-v-3797eff9><p data-v-3797eff9>Projects of health</p></div></div><main data-v-3797eff9><ol class="breadcrumb" data-v-3797eff9><li class="breadcrumb-item" data-v-3797eff9>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/projects" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a data-v-3797eff9${_scopeId}>Projects</a>`);
          } else {
            return [
      ...
      _push(`</li><li class="breadcrumb-item" data-v-3797eff9>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/projects/health" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<a data-v-3797eff9${_scopeId}>Health</a>`);
          } else {
            return [
      ...
      _push(`</div></div><br data-v-3797eff9><h2 data-v-3797eff9>Health projects</h2><div class="block" id="Transport projects" data-v-3797eff9> Here you can see our healthiest projects! <div class="projects" data-v-3797eff9><!--[-->`);
      ssrRenderList(unref(projects), (project) => {
        _push(`<div data-v-3797eff9><a class="project"${ssrRenderAttr("href", `/projects/${project.id}`)} data-v-3797eff9><h3 data-v-3797eff9>${ssrInterpolate(project.project_name)}</h3><br data-v-3797eff9><img${ssrRenderAttr("src", "../" + project.logo)} alt="Project Image" data-v-3797eff9><p data-v-3797eff9></p></a></div>`);
      });
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/projects/health.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const health = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3797eff9"]]);

export { health as default };
//# sourceMappingURL=health-779b97cf.mjs.map
