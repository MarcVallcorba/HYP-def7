...
<template>
  <div class = introduction>
        <div id = "title"><p>Projects of transport</p></div>
  </div> 
  <main>

    <ol class="breadcrumb">
         <li class="breadcrumb-item"> <NuxtLink to = "/projects"><a>Projects</a></NuxtLink></li>
         <li class="breadcrumb-item"> <NuxtLink to = "/projects/transport"><a>Transport</a></NuxtLink></li>
  </ol>
  
      <Overview class="overview" :sections="['The transport projects','Discover the area', 'Transport projects']"/>
      <Return></Return>

  <div class="thebody">
      <div class ="block" id="The transport projects">
        <h2>The transport projects</h2>
      ...
      <br>
        ...
        <div class = "buttons">
        <NuxtLink to = "/areas/transport/"><TheButton color = "#679436">Discover this area</TheButton></NuxtLink>
        </div>
    </div>
        <br>
        ...
        <div class ="block" id="Transport projects">
          ...
          Here you can see our faster growing and moving projects!
...
<style scoped>
    .introduction {
        background-image:  repeating-radial-gradient( circle at 0 0, transparent 0, #427AA1 20px ), repeating-linear-gradient( #0631616e, #427AA1 );
        padding-top:6%;
        font-size: 3vh;
        text-align:left;
        padding-bottom: 2%;
