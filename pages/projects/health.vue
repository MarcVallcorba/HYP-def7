...
<template>
  <div class = introduction>
        <div id = "title"><p>Projects of health</p></div>
  </div> 
  <main>

    <ol class="breadcrumb">
         <li class="breadcrumb-item"> <NuxtLink to = "/projects"><a>Projects</a></NuxtLink></li>
         <li class="breadcrumb-item"> <NuxtLink to = "/projects/health"><a>Health</a></NuxtLink></li>
  </ol>
  
      <Overview class="overview" :sections="['The health projects','Discover the area', 'Health projects']"/>
      <Return></Return>

  <div class="thebody">
      <div class ="block" id="The transport projects">
        <h2>The health projects</h2>
      ...
      <br>
        ...
        <div class = "buttons">
        <NuxtLink to = "/areas/health/"><TheButton color = "#679436">Discover this area</TheButton></NuxtLink>
        </div>
    </div>
        <br>
        

        <h2>Health projects</h2>
        <div class ="block" id="Transport projects">
          Here you can see our healthiest projects!
...
.introduction {
        background-image:  repeating-radial-gradient( circle at 0 0, transparent 0, #EBF2FA 20px ), repeating-linear-gradient( #adaeaf, #EBF2FA );
        padding-top:6%;
        font-size: 3vh;
        text-align:left;
        padding-bottom: 2%;
