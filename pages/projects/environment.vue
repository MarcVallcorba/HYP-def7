...
<template>
  <div class = introduction>
        <div id = "title"><p>Projects of environment</p></div>
  </div> 
  <main>

    <ol class="breadcrumb">
         <li class="breadcrumb-item"> <NuxtLink to = "/projects"><a>Projects</a></NuxtLink></li>
         <li class="breadcrumb-item"> <NuxtLink to = "/projects/transport"><a>Environment</a></NuxtLink></li>
  </ol>
  
      <Overview class="overview" :sections="['The environment projects','Discover the area', 'Environment projects']"/>
      <Return></Return>

  <div class="thebody">
      <div class ="block" id="The environment projects">
        <h2>The environment projects</h2>
        ...
        We are proud to celebrate the achievements of our supported projects, which serve as beacons of innovation, social impact, and technological advancement. From clean energy solutions that combat climate change to transformative transportation technologies that revolutionize mobility, and from breakthrough medical treatments that save lives to digital health platforms that enhance access to care, our supported projects are making a difference in their respective domains.
        <br>
      </div>
      <br>
      
        <div class ="block" id="Discover the area">
        <div class = "buttons">
        <NuxtLink to = "/areas/environment/"><TheButton color = "#679436">Discover this area</TheButton></NuxtLink>
        </div>
    </div>
        <br>
        ...
        <div class ="block" id="Environment projects">
          Here are our most ecofriendly projects!
        ...
        <div class="projects">
          <div v-for="project of projects" :key=index>
            <a class="project" :href="`/projects/${project.id}`" >
              ...
              <!--<img :src="`${project.product_service_name}`"  alt="Project Image">-->
              <!--<img src='{{project.product_service_name}}' alt="Project Image" />-->
              <p>
            </p>
            </a>
